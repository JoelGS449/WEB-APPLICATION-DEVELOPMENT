...
public class ServletControlador extends HttpServlet {
    ...
    private void actualizarProducto(HttpServletRequest request, HttpServletResponse response) 
        ...
        if(rpta){
            response.sendRedirect("mensaje.jsp?men=Se actualizo el pastel de manera correcta.");
        }else{
            response.sendRedirect("mensaje.jsp?men=No se actualizo el pastel.");
        }
    }
